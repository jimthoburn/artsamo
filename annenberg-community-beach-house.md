...
<dl>
  <dt>View and make reservations for all events</dt>
  <dd>
    <svg width="24" height="24" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" class="icon">
      <title>Website</title>
      <switch>
    ...
    <a href="https://annenbergbeachhouse.com/beachculture">eventbrite.com</a>
  </dd>

  <dt>Visit the Beach House website</dt>
  <dd>
    <svg width="24" height="24" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" class="icon">
      <title>Website</title>
      <switch>
